...
from continuums.imagenet100 import SplitImagenet100

data_objects = {
    'cifar100': CIFAR100,
    'cifar10': CIFAR10,
    'mini_imagenet': Mini_ImageNet,
    'imagenet100': SplitImagenet100,
}
...
class continuum(object):
    ...
    # Defined in the DataBase, cifar10 cifar100 / miniimagenet no longer defined
    def test_data(self):
